...
void Application::OnInit() {
    ...
    SceneBuilder::BuildDefaultScene(scene_.get());
    // SceneBuilder::BuildProceduralScene(scene_.get());
    ...
    program_->AddResourceBinding(grassland::graphics::RESOURCE_TYPE_IMAGE, 1024);              // space13 - texture array (bind)
    ...
    if (alive_) {
        ...
        if (pending_scene_index_ >= 0 && pending_scene_index_ != current_scene_index_) {
            const char* scene_names[] = {
                ...
                "Material Showcase", "Cornell Box 3", "Cornell Box 4", "Procedural Scene", "Bedroom Scene", "Motion Test"
            };
            ...
            switch (pending_scene_index_) {
                ...
                case 9: SceneBuilder::BuildMotionTestScene(scene_.get()); break;
            }
